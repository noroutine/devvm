#
# Bash Maven2 completion (taken from http://i.willcode4beer.com/other/maven2)
#
_mvn()
{
        local cmds cur colonprefixes

        # Here we should add goals of plugins we install
        ...
        cmds="clean validate compile test package integration-test \
                ...
                help:active-profiles help:active-profiles help:describe \
                help:effective-pom help:effective-settings help:evaluate \
                help:expressions help:help help:system \
                selenium:start-server cargo:start"
        COMPREPLY=()
